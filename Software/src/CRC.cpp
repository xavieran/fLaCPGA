...
void FLAC_CRC::crc8_update(const uint8_t data, uint8_t *crc) {
    *crc = crc8_table[*crc ^ data];
}

void FLAC_CRC::crc8_update_block(const uint8_t *data, unsigned len, uint8_t *crc) {
    while (len--)
        *crc = crc8_table[*crc ^ *data++];
}

uint8_t FLAC_CRC::crc8(uint8_t *data, unsigned len) {
    uint8_t crc = 0;
...
unsigned FLAC_CRC::crc16(const uint8_t *data, unsigned len) {
    unsigned crc = 0;
...
unsigned FLAC_CRC::crc16_table[256] = {
...
uint8_t FLAC_CRC::crc8_table[256] = {
