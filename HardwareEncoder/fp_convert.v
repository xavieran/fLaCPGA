...
module  fp_convert_altbarrel_shift_brf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_convert_altbarrel_shift_brf
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_altfp_convert_fhn
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	fp_convert_altbarrel_shift_brf   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //fp_convert_altfp_convert_fhn
//VALID FILE
...
module fp_convert (
	...
	fp_convert_altfp_convert_fhn	fp_convert_altfp_convert_fhn_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
