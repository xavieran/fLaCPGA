...
//altfp_div CBX_AUTO_BLACKBOX="ALL" DENORMAL_SUPPORT="NO" DEVICE_FAMILY="Cyclone II" OPTIMIZE="SPEED" PIPELINE=14 REDUCED_FUNCTIONALITY="NO" WIDTH_EXP=8 WIDTH_MAN=23 clk_en clock dataa datab result
...
//altfp_div_pst CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone II" FILE_NAME="fp_divider.v:a" PIPELINE=14 WIDTH_EXP=8 WIDTH_MAN=23 aclr clk_en clock dataa datab result
//VERSION_BEGIN 13.0 cbx_altbarrel_shift 2013:06:12:18:04:00:SJ cbx_altfp_div 2013:06:12:18:04:00:SJ cbx_altsyncram 2013:06:12:18:04:00:SJ cbx_cycloneii 2013:06:12:18:04:00:SJ cbx_lpm_abs 2013:06:12:18:04:00:SJ cbx_lpm_add_sub 2013:06:12:18:04:00:SJ cbx_lpm_compare 2013:06:12:18:04:00:SJ cbx_lpm_decode 2013:06:12:18:04:00:SJ cbx_lpm_divide 2013:06:12:18:04:00:SJ cbx_lpm_mult 2013:06:12:18:04:00:SJ cbx_lpm_mux 2013:06:12:18:04:00:SJ cbx_mgl 2013:06:12:18:04:42:SJ cbx_padd 2013:06:12:18:04:00:SJ cbx_stratix 2013:06:12:18:04:00:SJ cbx_stratixii 2013:06:12:18:04:00:SJ cbx_stratixiii 2013:06:12:18:04:00:SJ cbx_stratixv 2013:06:12:18:04:00:SJ cbx_util_mgl 2013:06:12:18:04:00:SJ  VERSION_END
...
module  fp_divider_altfp_div_pst_m0f
	( 
	aclr,
	clk_en,
	clock,
...
`endif
	...
	defparam
		altsyncram3.init_file = "fp_divider.hex",
	...
	assign
		...
		value_zero_w = {9{1'b0}};
endmodule //fp_divider_altfp_div_pst_m0f

//synthesis_resources = altsyncram 1 lpm_add_sub 4 lpm_compare 1 lpm_mult 5 mux21 74 reg 847 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_divider_altfp_div_jth
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	fp_divider_altfp_div_pst_m0f   altfp_div_pst1
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		aclr = 1'b0,
		result = wire_altfp_div_pst1_result;
endmodule //fp_divider_altfp_div_jth
//VALID FILE
...
module fp_divider (
	...
	fp_divider_altfp_div_jth	fp_divider_altfp_div_jth_component (
				.clk_en (clk_en),
				.clock (clock),
				.datab (datab),
				.dataa (dataa),
