...
module  int_convert_altbarrel_shift_grf
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //int_convert_altbarrel_shift_grf

//synthesis_resources = lpm_add_sub 5 lpm_compare 4 reg 281 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  int_convert_altfp_convert_fhn
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	int_convert_altbarrel_shift_grf   altbarrel_shift6
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
...
endmodule //int_convert_altfp_convert_fhn
//VALID FILE
...
module int_convert (
	...
	int_convert_altfp_convert_fhn	int_convert_altfp_convert_fhn_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
