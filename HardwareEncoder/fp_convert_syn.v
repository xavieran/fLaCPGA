...
//altfp_convert DEVICE_FAMILY="Cyclone II" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=64 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=64 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clk_en clock dataa result
...
//altbarrel_shift DEVICE_FAMILY="Cyclone II" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=64 WIDTHDIST=6 aclr clk_en clock data distance result
...
module  fp_convert_altbarrel_shift
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //fp_convert_altbarrel_shift
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_altpriority_encoder12345
	( 
	data,
	q,
	...
	assign
		q = {data[1]},
		zero = (~ (data[0] | data[1]));
endmodule //fp_convert_altpriority_encoder12345

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_altpriority_encoder1234
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	fp_convert_altpriority_encoder12345   altpriority_encoder17
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder17_q),
	.zero(wire_altpriority_encoder17_zero));
	fp_convert_altpriority_encoder12345   altpriority_encoder18
	( 
	.data(data[3:2]),
...
endmodule //fp_convert_altpriority_encoder1234

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_altpriority_encoder123
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	fp_convert_altpriority_encoder1234   altpriority_encoder15
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder15_q),
	.zero(wire_altpriority_encoder15_zero));
	fp_convert_altpriority_encoder1234   altpriority_encoder16
	( 
	.data(data[7:4]),
...
endmodule //fp_convert_altpriority_encoder123

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_altpriority_encoder12
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	fp_convert_altpriority_encoder123   altpriority_encoder13
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder13_q),
	.zero(wire_altpriority_encoder13_zero));
	fp_convert_altpriority_encoder123   altpriority_encoder14
	( 
	.data(data[15:8]),
...
endmodule //fp_convert_altpriority_encoder12

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_altpriority_encoder1
	( 
	data,
	q,
	zero) /* synthesis synthesis_clearbox=1 */;
	...
	fp_convert_altpriority_encoder12   altpriority_encoder11
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder11_q),
	.zero(wire_altpriority_encoder11_zero));
	fp_convert_altpriority_encoder12   altpriority_encoder12
	( 
	.data(data[31:16]),
...
endmodule //fp_convert_altpriority_encoder1
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_altpriority_encoder12345678910
	( 
	data,
	...
	assign
		q = {data[1]};
endmodule //fp_convert_altpriority_encoder12345678910

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_altpriority_encoder123456789
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [3:0]  data;
	...
	fp_convert_altpriority_encoder12345678910   altpriority_encoder25
	( 
	.data(data[1:0]),
	.q(wire_altpriority_encoder25_q));
	fp_convert_altpriority_encoder12345   altpriority_encoder26
	( 
	.data(data[3:2]),
...
endmodule //fp_convert_altpriority_encoder123456789

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_altpriority_encoder12345678
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [7:0]  data;
	...
	fp_convert_altpriority_encoder123456789   altpriority_encoder23
	( 
	.data(data[3:0]),
	.q(wire_altpriority_encoder23_q));
	fp_convert_altpriority_encoder1234   altpriority_encoder24
	( 
	.data(data[7:4]),
...
endmodule //fp_convert_altpriority_encoder12345678

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_altpriority_encoder1234567
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [15:0]  data;
	...
	fp_convert_altpriority_encoder12345678   altpriority_encoder21
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder21_q));
	fp_convert_altpriority_encoder123   altpriority_encoder22
	( 
	.data(data[15:8]),
...
endmodule //fp_convert_altpriority_encoder1234567

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_altpriority_encoder123456
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [31:0]  data;
	...
	fp_convert_altpriority_encoder1234567   altpriority_encoder19
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder19_q));
	fp_convert_altpriority_encoder12   altpriority_encoder20
	( 
	.data(data[31:16]),
...
endmodule //fp_convert_altpriority_encoder123456

//synthesis_resources = 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_altpriority_encoder
	( 
	data,
	q) /* synthesis synthesis_clearbox=1 */;
	input   [63:0]  data;
	...
	fp_convert_altpriority_encoder1   altpriority_encoder10
	( 
	.data(data[63:32]),
	.q(wire_altpriority_encoder10_q),
	.zero(wire_altpriority_encoder10_zero));
	fp_convert_altpriority_encoder123456   altpriority_encoder9
	( 
	.data(data[31:0]),
...
endmodule //fp_convert_altpriority_encoder


//lpm_add_sub DEVICE_FAMILY="Cyclone II" LPM_DIRECTION="ADD" LPM_WIDTH=63 ONE_INPUT_IS_CONSTANT="YES" dataa datab result
...
//lpm_add_sub DEVICE_FAMILY="Cyclone II" LPM_DIRECTION="SUB" LPM_WIDTH=8 ONE_INPUT_IS_CONSTANT="YES" dataa datab result
//VERSION_BEGIN 13.0 cbx_cycloneii 2013:06:12:18:04:00:SJ cbx_lpm_add_sub 2013:06:12:18:04:00:SJ cbx_mgl 2013:06:12:18:04:42:SJ cbx_stratix 2013:06:12:18:04:00:SJ cbx_stratixii 2013:06:12:18:04:00:SJ  VERSION_END


//lpm_add_sub DEVICE_FAMILY="Cyclone II" LPM_DIRECTION="ADD" LPM_WIDTH=12 ONE_INPUT_IS_CONSTANT="YES" cout dataa datab result
//VERSION_BEGIN 13.0 cbx_cycloneii 2013:06:12:18:04:00:SJ cbx_lpm_add_sub 2013:06:12:18:04:00:SJ cbx_mgl 2013:06:12:18:04:42:SJ cbx_stratix 2013:06:12:18:04:00:SJ cbx_stratixii 2013:06:12:18:04:00:SJ  VERSION_END
...
//lpm_add_sub DEVICE_FAMILY="Cyclone II" LPM_DIRECTION="ADD" LPM_WIDTH=8 ONE_INPUT_IS_CONSTANT="YES" dataa datab result
//VERSION_BEGIN 13.0 cbx_cycloneii 2013:06:12:18:04:00:SJ cbx_lpm_add_sub 2013:06:12:18:04:00:SJ cbx_mgl 2013:06:12:18:04:42:SJ cbx_stratix 2013:06:12:18:04:00:SJ cbx_stratixii 2013:06:12:18:04:00:SJ  VERSION_END


//lpm_compare DEVICE_FAMILY="Cyclone II" LPM_REPRESENTATION="UNSIGNED" LPM_WIDTH=8 alb dataa datab
...
//synthesis_resources = lut 112 reg 377 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_convert_altfp_convert
	( 
	clk_en,
	clock,
	dataa,
...
`endif
	...
	fp_convert_altbarrel_shift   altbarrel_shift5
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_convert_altpriority_encoder   altpriority_encoder2
	( 
	.data(prio_mag_int_a),
...
endmodule //fp_convert_altfp_convert
//VALID FILE
...
module fp_convert (
	...
	fp_convert_altfp_convert	fp_convert_altfp_convert_component (
				.clk_en (clk_en),
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
