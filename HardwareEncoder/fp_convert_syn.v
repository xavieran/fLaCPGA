...
//altfp_convert DEVICE_FAMILY="Cyclone II" OPERATION="INT2FLOAT" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=32 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=32 clk_en clock dataa result
...
//altbarrel_shift DEVICE_FAMILY="Cyclone II" PIPELINE=2 SHIFTDIR="LEFT" SHIFTTYPE="LOGICAL" WIDTH=32 WIDTHDIST=5 aclr clk_en clock data distance result
...
module  fp_convert_altpriority_encoder1234567
	...
	fp_convert_altpriority_encoder1234   altpriority_encoder22
	( 
	.data(data[3:2]),
...
module  fp_convert_altpriority_encoder123456
	...
	fp_convert_altpriority_encoder123   altpriority_encoder20
	( 
	.data(data[7:4]),
...
module  fp_convert_altpriority_encoder12345
	...
	fp_convert_altpriority_encoder123456   altpriority_encoder17
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder17_q));
	fp_convert_altpriority_encoder12   altpriority_encoder18
	( 
	.data(data[15:8]),
...
module  fp_convert_altpriority_encoder
	...
	fp_convert_altpriority_encoder12345   altpriority_encoder9
	( 
	.data(data[15:0]),
...
//lpm_add_sub DEVICE_FAMILY="Cyclone II" LPM_DIRECTION="ADD" LPM_WIDTH=31 ONE_INPUT_IS_CONSTANT="YES" dataa datab result
...
//synthesis_resources = lut 80 reg 247 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
