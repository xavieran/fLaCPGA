...
endmodule //fp_add_sub_altbarrel_shift_h0e
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_sub_altbarrel_shift_6hb
	( 
	data,
	distance,
	result) ;
	...
	assign
		...
		sel_w = {distance[4:0]},
		smux_w = {((({26{(sel_w[4] & (~ dir_w[4]))}} & {sbit_w[113:104], pad_w[15:0]}) | ({26{(sel_w[4] & dir_w[4])}} & {pad_w[15:0], sbit_w[129:120]})) | ({26{(~ sel_w[4])}} & sbit_w[129:104])), ((({26{(sel_w[3] & (~ dir_w[3]))}} & {sbit_w[95:78], pad_w[7:0]}) | ({26{(sel_w[3] & dir_w[3])}} & {pad_w[7:0], sbit_w[103:86]})) | ({26{(~ sel_w[3])}} & sbit_w[103:78])), ((({26{(sel_w[2] & (~ dir_w[2]))}} & {sbit_w[73:52], pad_w[3:0]}) | ({26{(sel_w[2] & dir_w[2])}} & {pad_w[3:0], sbit_w[77:56]})) | ({26{(~ sel_w[2])}} & sbit_w[77:52])), ((({26{(sel_w[1] & (~ dir_w[1]))}} & {sbit_w[49:26], pad_w[1:0]}) | ({26{(sel_w[1] & dir_w[1])}} & {pad_w[1:0], sbit_w[51:28]})) | ({26{(~ sel_w[1])}} & sbit_w[51:26])), ((({26{(sel_w[0] & (~ dir_w[0]))}} & {sbit_w[24:0], pad_w[0]}) | ({26{(sel_w[0] & dir_w[0])}} & {pad_w[0], sbit_w[25:1]})) | ({26{(~ sel_w[0])}} & sbit_w[25:0]))};
endmodule //fp_add_sub_altbarrel_shift_6hb
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_sub_altpriority_encoder_qb6
	( 
	data,
	q) ;
	input   [31:0]  data;
	...
	fp_add_sub_altpriority_encoder_r08   altpriority_encoder7
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder7_q));
	fp_add_sub_altpriority_encoder_rf8   altpriority_encoder8
	( 
	.data(data[31:16]),
...
endmodule //fp_add_sub_altpriority_encoder_qb6
...
module  fp_add_sub_altpriority_encoder_fj8
	...
	fp_add_sub_altpriority_encoder_vh8   altpriority_encoder23
	( 
	.data(data[7:0]),
	.q(wire_altpriority_encoder23_q),
	.zero(wire_altpriority_encoder23_zero));
	fp_add_sub_altpriority_encoder_vh8   altpriority_encoder24
	( 
	.data(data[15:8]),
...
module  fp_add_sub_altpriority_encoder_f48
	...
	fp_add_sub_altpriority_encoder_v28   altpriority_encoder30
	( 
	.data(data[15:8]),
...
module  fp_add_sub_altpriority_encoder_e48
	...
	fp_add_sub_altpriority_encoder_fj8   altpriority_encoder21
	( 
	.data(data[15:0]),
	.q(wire_altpriority_encoder21_q),
	.zero(wire_altpriority_encoder21_zero));
	fp_add_sub_altpriority_encoder_f48   altpriority_encoder22
	( 
	.data(data[31:16]),
...
`timescale 1 ps / 1 ps
//synopsys translate_on
module  fp_add_sub_altfp_add_sub_etk
	( 
	add_sub,
	clk_en,
	clock,
...
`endif
	...
	fp_add_sub_altbarrel_shift_h0e   lbarrel_shift
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	fp_add_sub_altbarrel_shift_6hb   rbarrel_shift
	( 
	.data({man_smaller_dffe13_wo, {2{1'b0}}}),
	.distance(rshift_distance_dffe13_wo),
	.result(wire_rbarrel_shift_result));
	fp_add_sub_altpriority_encoder_qb6   leading_zeroes_cnt
	( 
	.data({man_add_sub_res_mag_dffe21_wo[25:1], 1'b1, {6{1'b0}}}),
	.q(wire_leading_zeroes_cnt_q));
	fp_add_sub_altpriority_encoder_e48   trailing_zeros_cnt
	( 
...
endmodule //fp_add_sub_altfp_add_sub_etk
//VALID FILE
...
module fp_add_sub (
	...
	fp_add_sub_altfp_add_sub_etk	fp_add_sub_altfp_add_sub_etk_component (
				.add_sub (add_sub),
				.clk_en (clk_en),
				.clock (clock),
				.datab (datab),
